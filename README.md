...
[![Release](https://img.shields.io/github/v/release/latest-debs/herdr-debian)](https://github.com/latest-debs/herdr-debian/releases)
[![Build](https://github.com/latest-debs/herdr-debian/actions/workflows/release.yml/badge.svg)](../../actions)

Terminal workspace manager for coding agents — packaged for Debian as part of [latest-debs](https://github.com/latest-debs).
...
Or download a `.deb` from the [Releases](https://github.com/latest-debs/herdr-debian/releases) page:

```sh
sudo apt install ./herdr_*.deb
```

## Verify

```sh
apt-cache policy herdr
herdr --version
```
...
Run the [Build herdr for Debian](../../actions) workflow on GitHub with the
...
For issues with herdr itself, see
